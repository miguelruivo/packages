...
final class UrlLauncher implements UrlLauncherApi {
    ...
    /**
     * Creates an instance that uses {@code intentResolver} to look up the
     * handler for intents. This is to allow injecting an alternate resolver for
     * unit testing.
     */
    @VisibleForTesting
    ...
    Bundle extractBundle(Map<String, String> headersMap) {
